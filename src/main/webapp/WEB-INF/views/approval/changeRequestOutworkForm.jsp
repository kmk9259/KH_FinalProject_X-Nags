			...
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">외근 신청 수정</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						...
						<div class="form-group">
							<p>이전 외근일 : <fmt:formatDate type="date" dateStyle="long" value="${app.endDate }"/> </p>
							<input class="form-control date-picker" name="reDate" placeholder="외근일 변경" type="text">
						</div>
