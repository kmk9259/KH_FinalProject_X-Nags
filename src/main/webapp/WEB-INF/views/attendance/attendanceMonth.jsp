            ...
            <div class="min-height-200px">
	                ...
	                <div class="modal-dialog modal-dialog-centered">
	                    <div class="modal-content">
	                        <div class="login-box bg-white box-shadow border-radius-10">
	                            ...
	                            <form action="updateMonth.att" method="post">
            	...
            	$(function(){
            		...
            		$("#btn").click(function(){            			
            			...
            			console.log(orderBy);
            			console.log(attStatusNo);
            			if(orderBy == null || attStatusNo == null || attMonthDate == '')
            			{
            						...
            						if(right == '근태관리자')
            						{
        								$.each(list, function(i, obj){
            								...
            								function updateDay(){            									
            									...
            									console.log("obj.empId"+obj.empId);
            									console.log("obj.attNo"+obj.attNo);
            									$("#delBtn").click(function(){ 
                			            			...
                			            			$.ajax({
                		            					...
                		            					success:function(){
                		            						location.replace("attendanceMonth.att");
                		            					}
