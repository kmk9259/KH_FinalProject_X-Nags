...
<body>
	                ...
	                <div class="dropdown">
	                    <a role="button" >
	                       <span class="user-icon">
								<img src="${ pageContext.servletContext.contextPath }/resources/profile_files/${ sessionScope.loginUser.changeName }" alt="" style= "width:52px; height:52px; object-fit:cover; position: absolute; transform: translate(-50%, 0%); border-radius: 100%;">
							</span>
	                        <span class="user-name">${ sessionScope.loginUser.userName }님</span>&nbsp;&nbsp;&nbsp;
	                    </a>
	                    <a href="#" id="my" style="color: black"><i class="dw dw-user1"></i> MyPage
	                    </a> &nbsp;&nbsp;&nbsp;
    ...
    <jsp:include page="scSidebar.jsp"/>
