...
var FullCalendar = function (e) {
    ...
    i.diffed = function (e) {
        ...
        t && t.__H && t.__H.__h.length && (
            1 !== W.push(t) && U === i.requestAnimationFrame || ((U = i.requestAnimationFrame) || function (e) {
                var t,
                    n = function () {
                        clearTimeout(r),
    ...
    function zt(e) {
        return Ze(e.getUTCHours(), 2) + ":" + Ze(e.getUTCMinutes(), 2) + ":" + Ze(
            e.getUTCSeconds(),
            2
        )
    }
    ...
    var kr = function () {
            ...
            e.prototype.getUnitViewSpec = function (e) {
                var t,
                    ...
                    a = [].concat(
                        i.header
                            ? i.header.viewsWithButtons
                            : [],
                        i.footer
                            ? i.footer.viewsWithButtons
                            : []
                    );
                for (var s in o) 
                    a.push(s);
    ...
    var Lr = function () {
            ...
            e.prototype.diffWholeYears = function (e, t) {
                ...
                return gt(e) === gt(t) && n.getMarkerDay(e) === n.getMarkerDay(t) && n.getMarkerMonth(
                    e
                ) === n.getMarkerMonth(t)
            ...
            e.prototype.toDate = function (e, t) {
                return "local" === this.timeZone
                    ...
                    : "UTC" === this.timeZone
                        ...
                        : this.namedTimeZoneImpl
                            ? new Date(
                                e.valueOf() - 1e3 * this.namedTimeZoneImpl.offsetForArray(ft(e)) * 60
                            )
...
/ (auto | scroll) /.test(n.overflow + n.overflowY + n.overflowX) && t.push(
    ...
    function Ci(e, t, n, r, o) {
        return {
            header: e.headerToolbar
                ? wi(e.headerToolbar, e, t, n, r, o)
                : null,
            footer: e.footerToolbar
                ? wi(e.footerToolbar, e, t, n, r, o)
                : null
        }
    }
    ...
    function ki(e, t) {
        for (
            var n = Ct(t.getCurrentData().eventSources),
            r = [],
            o = 0,
            i = e;
            o < i.length;
        ...
        zo({
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t
                        .emitter
                        .trigger("datesSet", r(r({}, hr(e.activeRange, t.dateEnv)), {view: t.viewApi}))
                },
    ...
    var ts = function (e) {
        ...
        t.prototype.render = function () {
            ...
            }, Boolean(!v && p.length) && _o.apply(void 0, o([
                "thead", g
            ], p)), Boolean(!v && f.length) && _o.apply(void 0, o([
                "tbody", g
            ], f)), Boolean(!v && h.length) && _o.apply(void 0, o([
                "tfoot", g
            ], h)), v && _o.apply(void 0, o(o(o([
                "tbody", g
            ], p), f), h)))
        },
        ...
        t.prototype.renderChunkTd = function (e, t, n, r) {
            ...
            var o = this.props,
                ...
                f = Ga(e, n, {
                    tableColGroupNode: t,
                    tableMinWidth: "",
                    clientWidth: o.collapsibleWidth || void 0 === s[p]
                        ? null
                        : s[p],
                    clientHeight: void 0 !== l[p]
                        ? l[p]
                        : null,
    ...
    var vs = function (e) {
            ...
            t.prototype.render = function () {
                ...
                }, o.extraAttrs, {ref: this.handleRootEl}), _o("div", {
    ...
    var xs = function () {
        ...
        Ns = "function" == typeof performance
            ? performance.now
            : Date.now,
        Hs = function () {
            function e() {
            ...
            e.prototype.queryScrollEls = function (e) {
                for (var t = [], n = 0, r = this.scrollQuery; n < r.length; n++) {
                    ...
                    "object" == typeof o
                        ...
                        : t
                            .push
                            .apply(t, Array.prototype.slice.call(Te(e).querySelectorAll(o)))
                }
                return t
            },
            e
                    ...
                    if (e) {
                        ...
                        i === a || d.editable && d.droppable
                            ? (s = function (e, t, n) {
                                ...
                                c.mutatedEvents = l,
                                Ia(c, e.dateProfile, a) || (u = !0, s = null, l = null, c.mutatedEvents = {
                                    defs: {},
                                    instances: {}
                                })
                            )
                ...
                if (o.isDragging) {
                    ...
                    if (o.clearDrag(), t.emitter.trigger("eventDragStop", {
                        ...
                        if (a === t) {
                            ...
                            a
                                .emitter
                                .trigger("drop", r(r({}, Ws(f.dateSpan, a)), {
                                    draggedEl: e.subjectEl,
                                    jsEvent: e.origEvent,
            ...
            function e(e, t) {
                ...
                this.handleHitUpdate = function (e, t, o) {
                    ...
                    e && (
                        ...
                        }(e.dateSpan, n.dragMeta, a), u.mutatedEvents = Sn(s), (
                    ...
                    chunks: [
                        {
                            ...
                            content: function (e) {
                                ...
                                }, e.tableColGroupNode, _o("tbody", null, _o(kl, {slatMetas: i}))), _o("div", {
        ...
        Hl = function (e) {
            ...
            t.prototype.updateSizing = function () {
                ...
                n.onCoords && null !== n.clientWidth && (
                    this.rootElRef.current.offsetHeight && n.onCoords(new Pl(new So(
    ...
    var $l = function (e) {
        ...
        t.prototype.updateCoords = function () {
            var e,
                t = this.props;
            t.onColCoords && null !== t.clientWidth && t.onColCoords(new So(
                this.rootElRef.current,
    ...
    function ou(e, t, n, r, o) {
        for (
            ...
            var c = o.add(i, a),
                d = null !== Wt(s, l);
            u.push(
                {date: c, time: a, key: c.toISOString(), isoTimeStr: zt(c), isLabeled: d}
            ),
            a = Ot(a, r),
            s = Ot(s, r)
        }
    ...
    var fu = function (e) {
        ...
        t.prototype._eventStoreToSegs = function (e, t, n) {
            return this.eventRangesToSegs(Xn(
                e,
                t,
